            ...
            <div className="flex items-end gap-2">
              <div className="flex-1 relative">
                <Textarea
                  ...
                  disabled={isSending}
                  className="bg-muted/40 border-0 text-sm rounded-[10px] min-h-[56px] max-h-[160px] resize-none pr-12 py-4 w-full focus-visible:ring-1 focus-visible:ring-emerald-500/50 placeholder:text-muted-foreground/60 overflow-y-auto"
                  rows={1}
                />
