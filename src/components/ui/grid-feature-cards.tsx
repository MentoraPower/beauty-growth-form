...
export function FeatureCard({ feature, className, ...props }: FeatureCardPorps) {
	...
	return (
		<div className={cn('relative p-6 overflow-visible', className)} {...props}>
			{/* Corner squares - at the corners, half inside half outside */}
			<div className="absolute -top-1 -left-1 w-2 h-2 border border-foreground/20 bg-background" />
			<div className="absolute -top-1 -right-1 w-2 h-2 border border-foreground/20 bg-background" />
			<div className="absolute -bottom-1 -left-1 w-2 h-2 border border-foreground/20 bg-background" />
			<div className="absolute -bottom-1 -right-1 w-2 h-2 border border-foreground/20 bg-background" />
