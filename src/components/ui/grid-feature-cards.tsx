	...
	return (
		<div className={cn('relative group', className)} {...props}>
			...
			<div className="relative p-6 overflow-hidden h-full">
				...
				<feature.icon className="text-foreground/75 size-7 lg:size-8 relative z-10" strokeWidth={1.5} aria-hidden />
			<h3 className="mt-8 text-lg lg:text-xl xl:text-2xl font-bold relative z-10">{feature.title}</h3>
			<p className="text-muted-foreground relative z-20 mt-3 text-sm lg:text-base font-light leading-relaxed">{feature.description}</p>
			</div>
		</div>
	);
}
