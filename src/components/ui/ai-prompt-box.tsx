      ...
      <TooltipProvider>
        ...
        >
          <div
            ref={ref}
            className={cn(
              "border border-gray-200 bg-white p-2 shadow-lg transition-all duration-300",
              !className?.includes('rounded-t-none') && "rounded-3xl",
              className?.includes('rounded-t-none') && "rounded-b-3xl",
