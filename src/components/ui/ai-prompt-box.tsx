  ...
  return (
    <div className="relative flex flex-col rounded-3xl bg-gray-200/80 overflow-hidden">
      ...
      <div className="px-4 py-3">
        <span className="text-sm font-medium text-gray-500">Ask Scale to create</span>
      </div>
      ...
      <PromptInput
        ...
        className={cn(
          "w-full bg-white backdrop-blur-xl border-0 shadow-none transition-all duration-300 ease-in-out min-h-[130px] flex flex-col rounded-t-[25px] rounded-b-3xl",
