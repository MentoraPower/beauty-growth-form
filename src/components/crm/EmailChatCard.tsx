...
export function EmailChatCard({
  ...
  return (
    <div className="flex items-start gap-3 pl-2">
      {/* Timeline indicator - circle with vertical line */}
      <div className="flex flex-col items-center pt-2">
        {/* Vertical line above */}
        <div className="w-[2px] h-6 bg-zinc-700" />
        {/* Circle */}
        <div className="w-3 h-3 rounded-full border-2 border-zinc-500 bg-zinc-900 flex-shrink-0" />
      </div>
      ...
      <motion.div
        ...
        className="flex-1 max-w-sm cursor-pointer relative p-[1px] rounded-[10px] overflow-visible"
        style={{
        ...
        >
          ...
          <div className="flex-1 py-3 px-3 flex flex-col gap-2.5 min-w-0">
            ...
            <div className="flex items-center gap-1">
              ...
              <div className="w-3 h-3 border border-zinc-400 rounded-[1.5px] flex items-center justify-center flex-shrink-0">
                <div className="w-1 h-1 bg-zinc-400 rounded-[0.5px]" />
              </div>
