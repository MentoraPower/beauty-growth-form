        ...
        {!hasMessages ? (
          ...
          <>
            ...
            <div 
              ...
              className="flex-1 overflow-y-auto min-h-0 p-6 overscroll-contain [&::-webkit-scrollbar]:w-[2px] [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-foreground/8 [&::-webkit-scrollbar-thumb]:rounded-full"
              style={{ 
                scrollBehavior: 'auto',
