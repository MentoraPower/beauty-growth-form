    ...
    <div className="min-h-screen bg-card p-3">
      <div className="min-h-[calc(100vh-1.5rem)] relative">
        ...
        <div
          ...
          className="hidden lg:block fixed top-[4px] bottom-[12px] rounded-r-2xl bg-zinc-900 overflow-hidden"
        >
        ...
        >
          <div className="h-full overflow-hidden relative bg-card rounded-2xl p-6 shadow-sm flex flex-col">
            <PageTransition>
              {children}
            </PageTransition>
          </div>
