        ...
        <div className="overflow-hidden">
          <div className="ml-4 pt-1 pb-1 relative">
            ...
            <div className="relative flex items-center group py-0.5">
              {/* Vertical line segment coming from origin - stops at curve start */}
              <div className="absolute left-[3px] top-0 h-[12px] w-[2px] bg-[#b0b0b0] z-10" />
              {/* Curved line completing to Overview */}
            ...
            {originSubOrigins.map((subOrigin, index) => {
              ...
              return (
                <div key={subOrigin.id} className="relative flex items-center group py-0.5">
                  {/* Vertical line segment - stops at curve start */}
                  <div className="absolute left-[3px] top-0 h-[12px] w-[2px] bg-[#b0b0b0] z-10" />
                  {/* Curved line completing to sub-origin */}
                  <svg className="absolute left-[3px] top-[10px] w-5 h-4 z-0" viewBox="0 0 20 16" fill="none">
                    <path 
                      d="M0 0 C0 8, 8 14, 18 14" 
                      stroke="#b0b0b0" 
            ...
            <div className="relative flex items-center py-0.5">
              {/* Vertical line segment - stops at curve start */}
              <div className="absolute left-[3px] top-0 h-[12px] w-[2px] bg-[#b0b0b0] z-10" />
              {/* Curved line completing to button */}
              <svg className="absolute left-[3px] top-[10px] w-5 h-4 z-0" viewBox="0 0 20 16" fill="none">
                <path 
                  d="M0 0 C0 8, 8 14, 18 14" 
                  stroke="#b0b0b0" 
