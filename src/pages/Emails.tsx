                ...
                <tr>
                  <td style="padding: 32px 24px;">
                    ...
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                      <tr>
                        <td align="center" style="padding-bottom: 24px;">
                          <p style="margin: 0 0 12px 0; font-size: 14px; line-height: 1.6; color: #4a4a4a; text-align: center;">Nosso time vai entrar em contato com você nas próximas 24 horas.</p>
                          <p style="margin: 0; font-size: 14px; line-height: 1.6; color: #4a4a4a; text-align: center;">A Scale é o seu próximo passo para escalar o seu negócio no mundo da beleza.</p>
                        </td>
                      </tr>
                    </table>
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
