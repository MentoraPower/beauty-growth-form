  ...
  const initializeDefaultData = async () => {
    ...
    if (!existingTemplates || existingTemplates.length === 0) {
      ...
      await supabase.from("email_templates").insert({
        name: "Boas-vindas",
        subject: "Parabéns! Seu cadastro foi realizado com sucesso",
        body_html: `<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background: #ffffff;">
    <div style="text-align: center; margin-bottom: 24px;">
      <img src="https://scalebeauty.lovable.app/scale-beauty-banner.png" alt="Scale Beauty" style="width: 100%; max-width: 560px; border-radius: 12px;" />
    </div>
    <h1 style="color: #CC3A33; font-size: 28px; margin-bottom: 16px; font-weight: bold;">Parabéns, {{name}}!</h1>
    <p style="color: #333333; font-size: 16px; line-height: 1.6; margin-bottom: 16px;">O nosso time vai entrar em contato com você nas próximas 24 horas.</p>
    <p style="color: #333333; font-size: 16px; line-height: 1.6; margin-bottom: 24px;">A Scale é o seu próximo passo para escalar o seu negócio no mundo da beleza.</p>
    <p style="color: #666666; font-size: 14px; font-style: italic;">Uma assessoria de marketing por Emile Bitetti.</p>
  </div>`,
        is_default: true,
      });
    }
